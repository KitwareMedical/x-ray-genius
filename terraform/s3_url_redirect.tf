# This file contains infrastructure code to create S3 buckets for URL redirection from
# the root domain to the app subdomain. This allows users to go to xray-genius.com or
# www.xray-genius.com and be redirected to app.xray-genius.com.
