<template>
  <div class="d-inline-flex">
    <svg
      ...
      viewBox="0 0 181.05 32.13"
    >
      <g id="Layer_1-2" data-name="Layer 1">
        <g>
          <path
            class="cls-1"
            d="M45.22,13.38l3.6-5.5h3.29l-5.24,7.77,5.75,8.54h-3.29l-4.1-6.25-4.08,6.25h-3.29l5.72-8.54-5.22-7.77h3.29l3.57,5.5Z"
          />
          <path
            class="cls-3"
            d="M63.95,17.69l4.25,6.51h-3.29l-4-6.15h-2.89v6.15h-2.86V7.89h6.23c4.46,0,6.15,2.05,6.15,5.09,0,2.25-1.19,4.03-3.6,4.71ZM58.02,10.57v4.79h3.37c2.51,0,3.27-.96,3.27-2.38,0-1.52-.76-2.4-3.27-2.4h-3.37Z"
          />
          <path
            class="cls-3"
            d="M80.77,20.58h-6.89l-1.37,3.62h-2.96l6.31-16.31h2.94l6.31,16.31h-2.96l-1.37-3.62ZM74.87,17.89h4.89l-2.43-6.36-2.46,6.36Z"
          />
          <path
            class="cls-3"
            d="M93.7,17.87v6.33h-2.91v-6.28l-6.31-10.03h3.27l4.48,7.4,4.48-7.4h3.27l-6.28,9.98Z"
          />
          <path
            class="cls-3"
            d="M108.3,15.1h5.72v8.28c-1.01.61-2.58,1.09-4.74,1.09-5.37,0-7.62-2.51-7.62-8.43,0-4.89,2.13-8.38,7.5-8.38,2.28,0,3.75.56,4.81,1.12l-.43,2.69c-.91-.56-2.71-1.12-4.33-1.12-3.45,0-4.58,1.87-4.58,5.8,0,3.32.81,5.65,4.64,5.65.76,0,1.44-.13,2.1-.28v-3.92h-3.06v-2.48Z"
          />
          <path
            class="cls-3"
            d="M120.21,21.51h8.51v2.69h-11.37V7.89h11.37v2.69h-8.51v3.9h7.5v2.69h-7.5v4.36Z"
          />
          <path
            class="cls-3"
            d="M131.77,7.89h2.76l6.74,10.89V7.89h2.89v16.31h-2.76l-6.76-10.87v10.87h-2.86V7.89Z"
          />
          <path class="cls-3" d="M147.98,7.89h2.89v16.31h-2.89V7.89Z" />
          <path
            class="cls-3"
            d="M154.45,7.89h2.86v9.65c0,3.19,1.37,4.25,3.6,4.25s3.55-1.06,3.55-4.25V7.89h2.89v9.65c0,5.02-2.68,6.94-6.43,6.94s-6.46-1.92-6.46-6.94V7.89Z"
          />
          <path
            class="cls-3"
            d="M170.77,20.45c1.22.86,2.84,1.32,4.26,1.32,1.72,0,3.12-.63,3.12-2.05,0-3.22-7.95-1.44-7.95-7.34,0-3.29,2.76-4.71,5.65-4.71,1.7,0,3.44.51,4.69,1.42l-.86,2.61c-1.11-.91-2.58-1.34-3.85-1.34-1.52,0-2.71.61-2.71,1.87,0,3.5,7.95,1.62,7.95,7.24,0,3.55-2.99,5.02-6.08,5.02-1.85,0-3.72-.51-5.04-1.44l.84-2.58Z"
          />
        </g>
        <g>
